...
public class WLSDocs {
    ...
    public void unbiasedness() throws Exception {
        ...
        Array.of("Beta", "Alpha").forEach(coeff -> {
            ...
            Chart.hist(coeffResults, 250, chart -> {
                ...
                chart.writerPng(new File(String.format("../morpheus-docs/docs/images/wls/wls-%s-unbiasedness.png", coeff)), 700, 400);
                chart.show(700, 400);
            });
        });
    ...
    public void efficiency() throws Exception {
        ...
        Array.of("Alpha", "Beta").forEach(coeff -> {
            ...
            Chart.hist(data, 350, chart -> {
                ...
                chart.writerPng(new File(String.format("../morpheus-docs/docs/images/wls/wls-%s-efficiency.png", coeff)), 700, 400);
                chart.show(700, 400);
            });
        });
    ...
    public void consistency() throws Exception {
        ...
        Array.of("Beta", "Alpha").forEach(coeff -> {
            ...
            Chart.hist(coeffResults, 250, chart -> {
                ...
                chart.legend().on().bottom();
                //chart.writerPng(new File(String.format("../morpheus-docs/docs/images/wls/wls-%s-consistency.png", coeff)), 700, 400);
                chart.show(700, 400);
            });
        });
    ...
    public void residualVsPredicator() throws Exception {
        ...
        frame.regress().ols("Y", "X", true, model -> {
            ...
            Chart.withPoints(newData, "X", Double.class, chart -> {
                chart.plot(0).withPoints();
                chart.style("Residuals").withPointsVisible(true);
                chart.show();
            });
    ...
    public void residualVsFitted() throws Exception {
        ...
        frame.regress().ols("Y", "X", true, model -> {
            ...
            Chart.withPoints(newData, "Fitted", Double.class, chart -> {
                chart.plot(0).withPoints();
                chart.style("Residuals").withPointsVisible(true);
                chart.show();
            });
    ...
    public void plotWeights() throws Exception {
        ...
        Chart.of(weights, chart -> {
            chart.plot(0).withLines();
            chart.style("Weight").withColor(Color.RED);
            chart.show();
        });
    ...
    public void testSuper() throws Exception {
        ...
        Chart.of(frame.cols().select("y", "x"), "x",Double.class, chart -> {
            chart.plot(0).withPoints();
            chart.style("y").withPointsVisible(true).withColor(Color.BLUE);
